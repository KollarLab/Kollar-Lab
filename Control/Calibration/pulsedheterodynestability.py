...
def PulsedHeterodyneStability(instruments, settings):
    ...
    digitizertime = cardXaxis
    CosPC = numpy.cos(2*numpy.pi*IF_freq*digitizertime)
    SinPC = numpy.sin(2*numpy.pi*IF_freq*digitizertime)
    ...
    for tind in range(0, len(taus)):
        ...
        for rind in range(0, reads):
            ...
            for sind in range(0, card.segments):
                ...
                Is1 = data1[sind, pulse1_range[0]:pulse1_range[1]]*CosPC[pulse1_range[0]:pulse1_range[1]]
                Qs1 = data1[sind, pulse1_range[0]:pulse1_range[1]]*SinPC[pulse1_range[0]:pulse1_range[1]]

                Is2 = data1[sind, pulse2_range[0]:pulse2_range[1]]*CosPC[pulse2_range[0]:pulse2_range[1]]
                Qs2 = data1[sind, pulse2_range[0]:pulse2_range[1]]*SinPC[pulse2_range[0]:pulse2_range[1]]

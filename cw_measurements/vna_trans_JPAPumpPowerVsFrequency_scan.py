...
def vna_trans_JPAPumpPowerVsFrequency_scan(instruments, settings):
    '''
    ...
    filename_template = exp_settings['scanname'] + '_DcVolt{}v_' + stamp
    ...
    for pind in range(len(pump_powers)):
        ...
        for vind in range(len(voltages)):
            ...
            mags[vind]   = data['mag'] - data_off['mag']
            ...
            full_data = {}
            full_data['xaxis']  = pump_powers #data['xaxis']/1e9 #voltages #pump_freqs/1e9
            ...
            yaxis  = voltages[0:vind+1] #pump_powers[0:pind+1]

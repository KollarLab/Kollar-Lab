...
import os
import time
from pdh_measurements.pdh_funcs import NoDetector_dataNew
...
settings['mod_freq'] = 17e6 
settings['ddc_freq'] = 10e6 
settings['lo_power'] = 12
settings['lo_freq'] = 6.04e9
Normalize = True 
...
# measurement
data_dict = NoDetector_dataNew(instruments, settings)

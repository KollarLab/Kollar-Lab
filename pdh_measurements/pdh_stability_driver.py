...
import os
import time
from pdh_measurements.pdh_funcs import stability_pdh
...
settings['plotIQraw'] = False
settings['plot_ErrorSignal'] = False
...
# measurement
stability_pdh(instruments, settings, num_measure=2)

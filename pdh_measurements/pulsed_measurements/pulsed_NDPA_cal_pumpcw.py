...
def pulsed_NDPA_cal_pumpcw(instruments, settings):
    ...
    pumpgen.Power = pump_powers[0]
    pumpgen.Phase = 0
    pumpgen.disable_pulse()
    pumpgen.disable_IQ()
    pumpgen.Output = 'Off'
    ...
    for vind in range(voltage_points):
        ...
        for pind in range(pump_power_points):
            ...
            pumpgen.Power = pump_powers[pind]
            current_pump_power = pump_powers[pind] - exp_globals['CAV_Attenuation']
            ...
            for pfind in range(pump_freq_points):
                ...
                full_data['pump_freqs'] = pump_freqs[0:pfind+1]/1e9
                full_data['mags'] = diff_full[0:pfind+1] #powerdat_full[0:pfind+1]

...
def pulsed_pdh_TripleDDC_stability_FTW(instruments, settings):
    ##Instruments used
    ...
    cav_center = exp_settings['cav_center']
    cavitygen.freq = cav_center
    cavitygen.phase = 0
    cavitygen.enable_pulse()
    cavitygen.enable_IQ()

    LO.power = 12
    LO.freq = cav_center - exp_globals['IF']    
    LO.phase = 0
    ...
    print(f'Generator Powers| carrier:{carrier_power- CAV_Attenuation}, sideband:{lsb_power - CAV_Attenuation}, SGS:{gen_power-CAV_Attenuation}')

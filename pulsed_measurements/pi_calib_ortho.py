...
def pi_ortho(instruments, settings):
    ...
    for ii, angle in enumerate(angles):
        ...
        qubit_I.add_pulse('gaussian_square', position=position-delay-pulse_length, 
                          amplitude=p_amp*imb_scale[0], length = hold_time, 
        ...
        qubit_marker.add_window(position-2*delay-pulse_length, position+pulse_length+delay)

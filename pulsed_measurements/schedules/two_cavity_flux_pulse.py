...
class two_cavity_flux_pulse(base_schedule):
    '''
    ...
    the measurement tone as well as a total schedule time (th.e time for which we should generate 
    traces). 
    ...
    channel assignments. 
    '''
    def __init__(self, total_time, qpulse, FBL_pulse, mpulse1, mpulse2, awg='sim', awg2='sim'):
        '''
    ...
    def upload_schedule(self):
        ...
        [ch3, ch4, marker2] = self.compile_schedule(analog_list=['FBL', 'Blank2'], digital_list=['Boost', 'Blank'])

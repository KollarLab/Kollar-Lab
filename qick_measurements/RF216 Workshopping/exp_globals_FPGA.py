...
#LO settings
exp_globals['LO']       = False #Set to False for debugging purposes
exp_globals['LO_freq']  = 0e9
# exp_globals['LO_power'] = 22

#Channel config
exp_globals['cav_channel'] = {'ID' : 5, 'Atten_1' : 20, 'Atten_2': 20, 'BW': 0.5}
exp_globals['qub_channel'] = {'ID' : 6, 'Atten_1' : 0, 'Atten_2': 0, 'BW': 0.5}
exp_globals['ro_channel']   = {'ID' : 0, 'Atten' : 0, 'BW': 0.5} #Might not work
...
exp_globals['device_name'] = 'TXQ_v2'
...
#Clock config
exp_globals['relax_delay'] = 10 

#Pulse config 
measurement_pulse = {} #ALL IN MICROSECONDS
measurement_pulse['meas_pos']    = 10.1#80
measurement_pulse['init_buffer'] = 0.2
measurement_pulse['emp_delay']   = 0.5
measurement_pulse['meas_window'] = 1
...
qubit_pulse['sigma'] = 0.005 #0.02 
qubit_pulse['num_sigma'] = 4
qubit_pulse['delay'] = 0.1
qubit_pulse['piGain'] = 0.5 #?
qubit_pulse['hold_time'] = 0.023#20 #THIS ONLY AFFECTS CERTAIN SCRIPTS. Pulsed spec, for example, is always just a Gaussian

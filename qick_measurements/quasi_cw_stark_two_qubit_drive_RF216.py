# -*- coding: utf-8 -*-
"""
Created on Thu Aug 13 14:11:19 2026
...
class Quasi_CW(AveragerProgramV2):
    def _initialize(self,cfg): 
        ...
        self.declare_gen(ch=cfg["stark_channel"], nqz=cfg["nqz_q"], mixer_freq=cfg['stark_mixer_freq'])
        ...
        self.add_gauss(ch=stark_ch, name='ramp', sigma=sigma,length=sigma*num_sigma)
        ...
        self.add_pulse(ch=stark_ch, name="stark_pulse", ro_ch=ro_ch,
               style="flat_top",
               envelope="ramp",
               freq=cfg['stark_freq'],
               length= cfg['quasi_CW_len'],
...
# =============================================================================
        ...
        self.pulse(ch=cfg["stark_channel"],name='stark_pulse',t=ex_time)
...
def get_quasi_cw_settings():
    ...
    settings['meas_type'] = 'QuasiCW_stark'
...
def quasi_cw(soc,soccfg,instruments,settings):
    ...
    if qub_drive_index == 'D1':
        ...
        stark_ch = exp_globals['qub_channel_2']
        stark_channel = exp_globals['qub_channel_2']['ID']
        s_pulse = exp_globals['qubit_pulse_D2']
        ...
        stark_ch = exp_globals['qub_channel_1']
        stark_channel = exp_globals['qub_channel_1']['ID']
        s_pulse = exp_globals['qubit_pulse_D1']
    ...
    config = {
        ...
        'stark_freq'      : exp_settings['stark_freq']/1e6,
        ...
        'stark_gain'        : exp_settings['stark_gain'],
        ...
        'stark_mixer_freq' : exp_settings['stark_mixer_freq']/1e6,
    ...
    soc.rfb_set_gen_rf(stark_ch['ID'], stark_ch['Atten_1'], stark_ch['Atten_2'])
    ...
    if exp_settings['filter'] == 'all_filter':
        ...
        soc.rfb_set_ro_filter(config['stark_channel'], fc=config['stark_freq']/1000, ftype='bandpass', bw=stark_ch['BW'])
